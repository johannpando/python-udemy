...
def buscar_numero(archivo, patron):
    ...
    if re.search(patron, texto):
        ...
        # <re.Match object; span=(258, 268), match='Nhjn-54885'>
...
def crear_listas():
    for carpeta, subcarpeta, archivo in os.walk(ruta):
        for a in archivo:
            ...
            if resultado != '':
                nros_encontrados.append((resultado.group()))  # Guarda un resultado tal que asi: Nhjn-54885
                # print(a.title())
                archivos_encontrados.append(a.title())  # Imprime el nombre del fichero Archivo3.Txt
